...
const Project = React.lazy(() => import('./views/projects/projects'))
...
const routes = [
  ...
  { path: '/tasks', name: 'Tasks', element: TaskTable},
  ...
  { path: '/forgetpassword', name: 'Forget Password', element: ForgetPassword},
  ...
  { path: '/users', name: 'User Table', element: User},
]
